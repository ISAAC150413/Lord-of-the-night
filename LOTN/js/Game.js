class Game {
  ...
  start() {
    ...
    car1.addAnimation("car43",car43Image);
    car1.addAnimation("car44",car44Image);
    car1.addAnimation("car45",car45Image);
    car1.addAnimation("car46",car46Image);
    car1.scale = 1.2;

     
  car1.setCollider("rectangle",0,0,45,20);
  car1.debug = false
    ...
    car2.setCollider("rectangle",0,0,45,15);
    car2.debug = false
    //life
    
  arboll = createSprite(950,450,80,50);
  arboll.addImage("arboll,",arboll_img);
  arboll.scale = 2.6;

  arboll3 = createSprite(1150,370,20,50);
  arboll3.addImage("arboll,",arboll_img);
  arboll3.scale = 2.5;

  arbol4= createSprite(1330,400,20,50);
  arbol4.addImage("arboll,",arboll_img);
  arbol4.scale = 2.4;

  arbusto= createSprite(1150,550,20,50);
  arbusto.addImage("arbusto,",arbusto_img);
  arbusto.scale = 1;

  arbusto3= createSprite(1390,550,20,50);
  arbusto3.addImage("arbusto3,",arbusto_img);
  arbusto3.scale = 1;

  arbusto2= createSprite(1000,590,20,50);
  arbusto2.addImage("arbusto2,",arbusto_img);
  arbusto2.scale = 0.9;

  arboll2 = createSprite(135,246,20,50);
  arboll2.addImage("arboll2,",arboll2_img);
  arboll2.scale = 1.8;
   ...
   /*var obstaclesPositions = [
      ...
      { x: width / 2 , y: height - 300, image: obstacle2Image },
      { x: width / 2 , y: height - 200, image: obstacle1Image },
  ...
  handlePlayerControls() {
    ...
    if (!this.blast) {
      if (keyIsDown(UP_ARROW)&& player.positionY < width / 2 - 300 ) {
        ...
        car1.changeAnimation("car46",car46Image);
      ...
      if (keyIsDown(LEFT_ARROW) && player.positionX > width / 3 - 50) {
        ...
        car1.changeAnimation("car44",car44Image);
      ...
      if (keyIsDown(RIGHT_ARROW) && player.positionX < width / 2 + 300) {
        ...
        car2.changeAnimation("car12",car12Image);

        car1.changeAnimation("car43",car43Image);
      ...
      if (keyIsDown(DOWN_ARROW) && player.positionY < width / 2 + 300) {
        ...
        car1.changeAnimation("car45",car45Image);
        //car2.changeAnimation("car7",car7Image);
